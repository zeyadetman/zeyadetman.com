...
- `/syncNotion` Publishing pages to [notes.zeyadnotes.dev](http://notes.zeyadnotes.dev) from Notion.
...
- [https://notes.zeyadnotes.dev/watch-list/](https://notes.zeyadnotes.dev/watch-list/)
- [https://notes.zeyadnotes.dev/games/](https://notes.zeyadnotes.dev/games/)
