...
**[Here's the source code for this site.](https://github.com/zeyadetman/zeyadnotes.dev)**
...
After building and deploying the code I got this url https://www.zeyadnotes.dev/rss.xml with all posts metadata, Heading to https://www.getrevue.co/app/integrations/rss, And add the production url to `ADD A FEED` input. This will reflect in the issues page on getrevue account.
...
- [How to make your custom domain secure with SSL](http://help.getrevue.co/en/articles/4465817-how-to-make-your-custom-domain-secure-with-ssl): This helps me creating `https://feed.zeyadnotes.dev` and added it to getrevue custom domain.
